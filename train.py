...
def prepare_run(args):
    ...
    if args.dataset == 'LRW':
        ...
        excluded_speakers = [
            ...
            'michael2@wandlebury.co.uk',  # tape over mouth (CHECK DNN RESULTS)
        ...
        for data_capture in data_captures:
            ...
            # grab the results of the DNN phrase recognition on the SRAVI data
            good_samples = []
            recognition_results_path = dc_path.joinpath('dnn_phrase_recognition_results.csv')
            if not recognition_results_path.exists(): continue
            with recognition_results_path.open('r') as f:
                for line in f.read().splitlines():
                    ...
                    if not predictions:
                        continue
                    is_r1 = groundtruth == predictions[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument('dataset', choices=['LRW', 'GRID', 'SRAVI_extended', 'SRAVI_local'])
